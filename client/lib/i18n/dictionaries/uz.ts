...
export const uz = {
  ...
  invitations: {
    ...
    acceptedNote:
      'Siz akademiyaning zaxira tarkibiga qo‘shilyapsiz. Menejer sizni u yerdan jamoaga o‘tkazadi.',
    acceptedToast: 'Siz qabul qildingiz. Bir zumda zaxira tarkibga qo‘shilasiz.',
    rejectedToast: 'Taklif rad etildi.',
    undone: 'Javob qaytarib olindi.',
    rejectDialogBody:
      '{academy} bu haqda biladi. Ular uchun qisqa izoh qo‘shishingiz mumkin — bu ixtiyoriy.',
    rejectNote: 'Izoh (ixtiyoriy)',
    rejectNotePlaceholder: 'Sabab yoki izoh qo‘shing (ixtiyoriy)…',
  ...
  academy: {
    ...
    teamEmptyTitle: 'Jamoa hali shakllantirilmagan',
    teamEmptyHint: 'Akademiya jamoasi haqida ma’lumot tez orada paydo bo‘ladi.',
    roleManagers: 'Menejerlar',
    roleCoaches: 'Murabbiylar',
    roleScouts: 'Skautlar',
  ...
  trials: {
    ...
    addedToSquadDone: 'Taklif yuborildi — o‘yinchi unga javob beradi.',
    ...
    addToSquad: 'Tarkibga taklif qilish',
    ...
    assignedCoachesHint: 'Bu sinovda kim ishlaydi — va unda qaror yoza oladigan yagona odamlar.',
    runByCoach: 'O‘tkazadigan murabbiy',
    runByCoachHint: 'U sinovdan keyin qarorni yozadi.',
    chooseCoach: 'Murabbiyni tanlang',
    noCoachesYet: 'Avval akademiyaga murabbiy qo‘shing — sinovni kimdir o‘tkazishi kerak.',
    ...
    history: 'Tarix',
    historyHint: 'Siz arxivlagan sinovlar. Ariza berganlarning hammasi ularda qoladi.',
    noHistory: 'Tarix bo‘sh',
    noHistoryHint:
      'Sinov siz uni arxivlaganingizdan keyin shu yerda ko‘rinadi. Hech narsa o‘zi arxivlanmaydi.',
    ...
    globalTrialsHint:
      'Ochiq kun: siz e’lon qilasiz, mos keladigan har qanday o‘yinchi ariza beradi, siz tayinlagan murabbiylar o‘sha kuni o‘tdi yoki o‘tmadi deb belgilaydi.',
    createGlobalTrial: 'Umumiy sinov yaratish',
    privateTrials: 'Yopiq sinovlar',
    privateTrialsHint:
      'Har birida bitta o‘yinchi, siz tayinlagan murabbiy o‘tkazadi. Siz yoki murabbiy kimnidir taklif qilganda — kelgan tavsiyalardan yoki profilidan — shu yerda ko‘rinadi.',
    noPrivateTrials: 'Yopiq sinov yo‘q',
    noPrivateTrialsHint:
      'Yopiq sinov siz yoki murabbiy o‘yinchini unga taklif qilganingizda paydo bo‘ladi.',
    // Murabbiy ko‘rinishi
    coachTrialsHint: 'Siz ishlayotgan sinovlar va sizning qaroringizni kutayotgan o‘yinchilar.',
    ...
    trialHasNoCoaches:
      'Bu sinovda hali murabbiy ishlamayapti, shuning uchun arizachilar bo‘yicha qarorni hech kim yoza olmaydi. Quyida kamida bittasini tanlang.',
    /* Ariza bilan nima bo‘layotgani, har bir holat uchun — ApplicantCard. */
    stepApplied: 'Sinovda murabbiyning qarorini kutmoqda.',
    stepInvited: 'Taklif qilindi. Futbolchining javobi kutilmoqda.',
    stepConfirmed: 'Sinovga keladi. Murabbiyning qarorini kutmoqda.',
  ...
  recommendations: {
    invite: 'Taklif qilish',
    inviteToPrivateTrial: 'Yopiq sinovga taklif qilish',
    inviteTitle: 'Yopiq sinovga taklif',
    inviteCreatesTrial:
      'Yuborish bu o‘yinchi uchun bitta murabbiy o‘tkazadigan yopiq sinov yaratadi. Uni faqat o‘yinchi, siz va o‘sha murabbiy ko‘radi.',
    ...
    inboxFlowHint:
      'O‘yinchini yopiq sinovga taklif qiling yoki tavsiyani rad eting. Sinov hal qiladi — onlayn hech narsa baholanmaydi.',
    inboxEmpty: 'Yangi tavsiya yo‘q',
    inboxEmptyHint: 'Skaut akademiyangizga o‘yinchi tavsiya qilganda, u shu yerda ko‘rinadi.',
    history: 'Tavsiyalar tarixi',
    historyHint: 'Siz sinovga taklif qilgan o‘yinchilar va siz rad etganlar.',
    historyEmpty: 'Tarix hozircha bo‘sh',
    historyEmptyHint: 'Siz taklif qilgan yoki rad etgan o‘yinchilar shu yerga o‘tadi.',
  ...
  admin: {
    ...
    /* Ishlov berish holati bo‘yicha ro‘yxat — qotib qolgan yuklash shu yerda topiladi. */
    awaitingReview: 'Tekshiruv kutmoqda',
    statusFilterLabel: 'Ishlov berish holati',
    statusLabels: {
      ALL: 'Barchasi',
    ...
    moderationLabels: {
      UNVERIFIED: 'Tekshiruv kutmoqda',
      VERIFIED: 'Tasdiqlangan',
      BLOCKED: 'Bloklangan',
    },
    noClipsForStatus: 'Bu holatda video yo‘q.',
    noClipsForStatusHint: 'Yuqoridan boshqa holatni tanlang yoki tekshiruv navbatiga qayting.',
    stuckHint:
      'Odatda ishlov berish bir necha daqiqa oladi. Yarim soatdan ko‘p ishlov berilayotgan va faol vazifasi bo‘lmagan video qotib qolgan: server uni avtomatik ravishda uch martagacha qayta navbatga qo‘yadi, so‘ng xato deb belgilaydi.',
    processingSince: 'Ishlov berish boshlangan',
    jobState: 'Vazifa',
    jobStates: {
      active: 'bajarilmoqda',
      waiting: 'navbatda',
      delayed: 'navbatda, qayta urinish rejalashtirilgan',
      prioritized: 'navbatda',
      'waiting-children': 'navbatda',
      completed: 'tugadi, lekin video yangilanmadi',
      failed: 'xato bilan tugadi — hech kim ustida ishlamayapti',
      none: 'vazifa yo‘q — hech kim ustida ishlamayapti',
      unknown: 'noma’lum',
    } as Record<string, string>,
    jobAttempts: 'Urinishlar',
    restarts: 'Qayta ishga tushirishlar',
  ...
  blog: {
    ...
    title: 'Blog',
    tagline:
      'Futbol yangiliklari, iqtidorli yosh futbolchilar, akademiyalar, yangi transferlar, ochiq sinovlar va FotSpot yangiliklari.',
    categories: 'Bo‘limlar',
    allPosts: 'Barchasi',
    top: 'Eng yaxshi',
    topPosts: 'Eng ko‘p yoqtirilganlar',
    seeAllTop: 'Barcha mashhur maqolalar',
    latest: 'So‘nggi',
    thisWeek: 'Shu hafta',
    featured: 'Asosiy',
    readMore: 'O‘qish',
    minRead: 'daq. o‘qish',
    likes: '{count} ta yoqdi',
    like: 'Maqolani yoqtirish',
    unlike: 'Yoqtirishni bekor qilish',
    likePrompt: 'Foydali bo‘ldimi? Yoqtiring — bu boshqalarga topishga yordam beradi.',
    related: 'Keyingi o‘qish',
    results: 'Natijalar',
    olderPosts: 'Eskiroq maqolalar',
    onlyOneSoFar: 'Birinchi maqola yuqorida — yangilari yo‘lda.',
    nothingYet: 'Hali hech narsa chop etilmagan',
    nothingYetHint: 'Birinchi maqolalar yozilmoqda. Tez orada qaytib keling.',
    nothingFound: 'Hech narsa topilmadi',
    nothingFoundHint: 'Mos maqola yo‘q. Boshqa bo‘lim yoki so‘rovni sinab ko‘ring.',
    search: 'Blogdan qidirish',
    searchPlaceholder: 'Maqolalarni qidirish…',
    uncategorised: 'Maqola',
    postNotFound: 'Bu maqola topilmadi',
    postNotFoundHint: 'U olib tashlangan, ko‘chirilgan yoki manzil noto‘g‘ri bo‘lishi mumkin.',
    exploreTitle: 'FotSpotda kashf eting',
    ...
    manage: 'Blog',
    manageHint:
      'Maqolalar yozing va chop eting: yangiliklar, futbolchilar, akademiyalar, transferlar, sinovlar, yangilanishlar.',
    ...
    noPosts: 'Hali maqola yo‘q',
    noPostsHint: 'Birinchisini yozing.',
    fieldTitle: 'Sarlavha',
    fieldSlug: 'Manzil (slug)',
    fieldSlugHint:
      'Saqlaganda sarlavhadan yasaladi. Kichik lotin harflari, raqamlar va defis. Keyin o‘zgartirsangiz, odamlardagi havolalar buziladi.',
    regenerateSlug: 'Sarlavhadan',
    fieldExcerpt: 'Qisqacha',
    fieldExcerptHint:
      'Bir-ikki jumla. Kartochkalarda ko‘rinadi va pastda alohida yozmasangiz, qidiruv tavsifi sifatida ishlatiladi.',
    fieldContent: 'Matn',
    fieldContentHint:
      'Markdown: # va ## sarlavhalar, **qalin**, *kursiv*, [matn](url), ![izoh](rasm url), - ro‘yxat, > iqtibos, --- chiziq. /players, /academies yoki /trials havolalari FotSpot ichida qoladi. Alohida qatordagi YouTube havolasi pleyerga aylanadi.',
    preview: 'Ko‘rish',
    write: 'Yozish',
    ...
    fieldFeatured: 'Bu maqolani blog bosh sahifasida asosiy qilib ko‘rsatish',
    fieldCover: 'Muqova rasmi',
    fieldCoverAlt: 'Muqova alt matni',
    fieldCoverAltHint: 'Rasmni ekran o‘quvchilari va qidiruv tizimlari uchun tasvirlaydi.',
    upload: 'Yuklash',
    replace: 'Almashtirish',
    removeImage: 'O‘chirish',
    uploading: 'Yuklanmoqda…',
    uploadFailed: 'Yuklash amalga oshmadi. Qayta urinib ko‘ring.',
    filingSection: 'Joylashtirish',
    filingHint: 'Maqola blogda qayerda turadi va kim nomidan chiqadi.',
    seoSection: 'SEO',
    seoHint: 'Bo‘sh maydonlar o‘rniga maqolaning o‘zi ishlatiladi.',
    fieldSeoTitle: 'SEO sarlavha',
    fieldMetaDescription: 'Meta tavsif',
    fieldSeoKeywords: 'Kalit so‘zlar',
    fieldSeoKeywordsHint:
      'Vergul bilan ajrating. Siz o‘zgartirguncha sarlavha, qisqacha mazmun va matndan taklif qilinadi; 3–8 ta aniq so‘z eng yaxshisi.',
    suggestKeywords: 'Taklif',
    fieldCanonicalUrl: 'Kanonik URL',
    fieldCanonicalUrlHint: 'Faqat maqola avval boshqa joyda chop etilgan bo‘lsa.',
    fieldOgTitle: 'Ulashish sarlavhasi',
    fieldOgDescription: 'Ulashish tavsifi',
    fieldOgImage: 'Ulashish rasmi',
    fieldOgImageHint: 'Havola ulashilganda ko‘rinadi. Bo‘sh bo‘lsa, muqova ishlatiladi.',
    saveDraft: 'Qoralamani saqlash',
    save: 'Saqlash',
    publish: 'Chop etish',
    unpublish: 'Chop etishni bekor qilish',
    deletePost: 'Maqolani o‘chirish',
    confirmDelete: 'Maqola butunlay o‘chirilsinmi? Yoqtirishlar va rasmlar ham o‘chadi.',
    confirmUnpublish: 'Maqola blogdan olinsinmi? Qayta chop etilguncha manzili ishlamaydi.',
    saved: 'Saqlandi.',
    publishedToast: 'Chop etildi. Blogda ko‘rinmoqda.',
    unpublishedToast: 'Chop etish bekor qilindi.',
    deletedToast: 'Maqola o‘chirildi.',
    viewOnBlog: 'Blogda ko‘rish',
    manageCategories: 'Bo‘limlar',
    manageCategoriesHint:
      'Blog maqolalari joylashadigan bo‘limlar. Bo‘limni o‘chirsangiz, maqolalar qoladi.',
    newCategory: 'Yangi bo‘lim',
    categoryName: 'Nomi',
    categorySlug: 'Manzil',
    categoryDescription: 'Tavsif',
    categorySortOrder: 'Tartib',
    noCategories: 'Hali bo‘limlar yo‘q.',
    confirmDeleteCategory: 'Bo‘lim o‘chirilsinmi? Maqolalar bo‘limsiz qoladi.',
    lastEdited: 'Tahrirlangan',
    previewNeedsSave: 'Tayyor maqolani ko‘rish uchun avval saqlang.',
    /* /admin/blog/:id dagi rasm paneli — yuklang, manzilni nusxalang, matnga qo‘ying. */
    mediaTitle: 'Maqola rasmlari',
    mediaHint:
      'Rasm yuklang, manzilini nusxalang va matnga ![tavsif](manzil) ko‘rinishida qo‘ying. Faqat manzil kerak — fayl CDN’da saqlanadi.',
    mediaUpload: 'Rasm yuklash',
    mediaEmpty: 'Hali rasm yuklanmagan.',
    mediaCopyUrl: 'Manzilni nusxalash',
    mediaCopyMarkdown: 'Markdown nusxalash',
    mediaCopied: 'Nusxalandi',
    mediaDelete: 'O‘chirish',
    mediaDeleteTitle: 'Bu rasm o‘chirilsinmi?',
    mediaDeleteHint:
      'U darhol saqlashdan o‘chiriladi. Agar matn unga havola qilsa, o‘sha rasm buzilgan ko‘rinadi.',
    mediaDeleting: 'O‘chirilmoqda…',
    mediaOnlyImages: 'Bu yerga faqat rasm (JPEG, PNG, WebP, GIF, AVIF) yuklash mumkin.',
    mediaTooLarge: 'Fayl {max} MB dan katta. Yuklashdan oldin kichraytiring.',
    mediaSaveFirst: 'Avval maqolani qoralama sifatida saqlang, so‘ng bu yerga rasm yuklang.',
    createdFirst: 'Rasm yuklash uchun avval maqolani bir marta saqlang.',
  },
  landing: {
    ...
    recentlyJoined: 'FotSpot talantlari',
    recentlyJoinedBody: 'Baholangan videolari bor futbolchilar — har safar boshqalari.',
    viewMyCard: 'Kartamni ko‘rish',
    watchHighlights: 'Videoni ko‘rish',
    latestClips: 'Trenddagi o‘yinchilar',
    latestClipsBody: 'Hozir lentada eng ko‘p ko‘rilayotgan videolar.',
    ...
    pipelineBypass:
      'Ochiq sinov: o‘yinchilar to‘g‘ridan-to‘g‘ri ariza beradi — tavsiya shart emas.',
    ...
    value: {
      ...
      academies: {
        ...
        points: [
          ...
          'O‘yinchini profilidan to‘g‘ridan-to‘g‘ri yopiq sinovga taklif qiling',
