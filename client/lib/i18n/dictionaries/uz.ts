...
export const uz = {
  ...
  blog: {
    ...
    fieldContent: 'Matn',
    fieldContentHint:
      'Markdown: # va ## sarlavhalar, **qalin**, *kursiv*, [matn](url), ![izoh](rasm url), - ro‘yxat, > iqtibos, --- chiziq. /players, /academies yoki /trials havolalari FotSpot ichida qoladi.',
    preview: 'Ko‘rish',
    write: 'Yozish',
    ...
    fieldSeoKeywordsHint: 'Vergul bilan ajrating.',
