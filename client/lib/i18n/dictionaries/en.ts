...
export const en: Dictionary = {
  ...
  blog: {
    ...
    fieldContentHint:
      'Markdown: # and ## for headings, **bold**, *italic*, [text](url), ![caption](image url), - lists, > quotes, --- for a rule. Links to /players, /academies or /trials stay inside FotSpot.',
    preview: 'Preview',
    write: 'Write',
    ...
    fieldSeoKeywordsHint: 'Comma-separated.',
