...
export const en: Dictionary = {
  ...
  invitations: {
    ...
    acceptedNote:
      'You are joining the academy’s reserve. A manager moves you into a squad from there.',
    acceptedToast: 'You accepted. You join the reserve in a moment.',
    rejectedToast: 'Invitation turned down.',
    undone: 'Answer taken back.',
    rejectDialogBody: '{academy} will be told. You can add a short note for them — it is optional.',
    rejectNote: 'Note (optional)',
    rejectNotePlaceholder: 'Add an optional reason or note…',
  ...
  professional: {
    ...
    subtitle: 'Professional footballers who came through academies.',
    subtitleOne: 'Professional footballer',
    search: 'Search by name',
    empty: 'No professional players yet.',
    emptyHint: 'Players an admin adds appear here.',
    noResults: 'Nobody by that name.',
    developedThrough: 'Developed through',
    noAcademies: 'No academy listed.',
    alumniTitle: 'Professionals from this academy',
    alumniHint: 'Professional footballers who developed here.',
    manage: 'Professional players',
    manageHint: 'Create and edit the list of professional footballers.',
    add: 'Add professional player',
    edit: 'Edit',
    delete: 'Delete',
    confirmDelete: 'Remove this professional player from the list?',
    firstName: 'First name',
    lastName: 'Last name',
    position: 'Position',
    ...
    photoTooLarge: 'The photo is over 2 MB.',
    photoType: 'Image files only.',
    academies: 'Academies',
    academiesHint: 'Tick the academies this player came through.',
    searchAcademies: 'Search academies',
    save: 'Save',
    saved: 'Saved.',
    deleted: 'Deleted.',
    editorTitle: 'Professional players',
    editorHint:
      'Mark the professional footballers who came through your academy. They appear on the public page.',
    searchPlayers: 'Search professional players',
    noneSelected: 'Nobody selected yet.',
    alreadyAdded: 'Added',
    addToAcademy: 'Add',
    removeFromAcademy: 'Remove',
  },
  academy: {
    ...
    teamEmptyTitle: 'The team has not been formed yet',
    teamEmptyHint: 'Details about the academy’s team will appear soon.',
    ...
    noTrialsNowManagerHint:
      'Announce a trial from the Trials page and eligible players will be told.',
    ...
    noMatches: 'No academies match those filters',
    noMatchesHint: 'Try another name, province or district, or clear the filters.',
    searchName: 'Search by academy name',
    mapTitle: 'Academies on the map',
    mapHint: 'Only academies that have set their location are shown. Press a pin for the academy.',
    noneOnMap: 'No academy has set its location yet.',
  ...
  player: {
    ...
    cannotRecommendRestricted:
      'Your account has been restricted from writing recommendations. Contact support if you have questions.',
  ...
  trials: {
    ...
    addedToSquadDone: 'Invitation sent — the player answers it.',
    passedToast: 'Player passed the trial.',
    failedToast: 'Player marked as not passed.',
    verdictUndone: 'Verdict taken back.',
    ...
    notEligibleAge: 'This trial is for ages {min}–{max}; you are {age}.',
    notEligibleGender: 'This trial is for {gender} only.',
    searchTrials: 'Search by trial name',
    academyFilter: 'Academy',
    anyAcademy: 'Any academy',
    anyGender: 'Any gender',
    genderOptionMale: 'Male',
    genderOptionFemale: 'Female',
    genderOptionGeneral: 'General',
    ...
    sheet: 'Trial sheet',
    sheetHint:
      'Who is on the pitch, and what you said about them. Pass is one press and can be undone for a moment; Fail asks first.',
    participants: 'Participants',
    noParticipantsYet: 'No players are ready for the trial yet.',
    noParticipantsYetHint: 'Players appear here after they accept the invitation.',
    pendingInvitations: '{count} invitations pending',
    privateQueueHint: 'One player each. Pass or fail them right here — nothing to open.',
    globalQueueHint: 'Sessions you work. Open one to judge its players together.',
    ...
    pass: 'Pass',
    fail: 'Fail',
    failPlayer: 'Fail player',
    verdictNoteOptional: 'Note (optional)',
    verdictNotePlaceholder: 'Add an optional reason or note…',
  ...
  recommendations: {
    ...
    report: 'Report',
    reportTitle: 'Report this recommendation',
    reportHint:
      'The report goes to the moderators. The recommendation stays as it is until they decide.',
    reportReason: 'Reason',
    reportPlaceholder: 'Why do you find this text inappropriate?',
  ...
  admin: {
    ...
    recommendationReport: 'Recommendation text',
    reportedBy: 'Reported by',
    reportedText: 'Reported text',
    noReportedText: 'No text',
    skipReport: 'Skip',
    restrictScout: 'Restrict scout',
    confirmRestrictScout:
      'The scout will no longer be able to write recommendations, and their existing ones will be hidden from users. Continue?',
    scoutRestricted: 'Restricted',
    restrictAccount: 'Restrict from recommending',
    liftRestriction: 'Lift restriction',
    restrictHint:
      'A restricted account cannot write new recommendations, and its existing ones are visible to moderators only.',
  ...
  blog: {
    ...
    title: 'Blog',
    tagline:
      'Football news, talented young players, academies, new signings, open trials and what changed on FotSpot.',
    categories: 'Categories',
    allPosts: 'All',
    top: 'Top',
    topPosts: 'Top posts',
    seeAllTop: 'See all top posts',
    latest: 'Latest',
    thisWeek: 'This week',
    featured: 'Featured',
    readMore: 'Read',
    ...
    likePrompt: 'Found this useful? Leave a like — it helps others find it.',
    related: 'Read next',
    results: 'Results',
    olderPosts: 'Older posts',
    onlyOneSoFar: 'The first story is above — more are on the way.',
    nothingYet: 'Nothing published yet',
    nothingYetHint: 'The first stories are being written. Check back soon.',
    nothingFound: 'Nothing here',
    nothingFoundHint: 'No posts match. Try another category or search.',
    search: 'Search the blog',
    searchPlaceholder: 'Search posts…',
    uncategorised: 'Post',
    postNotFound: 'This post is not here',
    postNotFoundHint: 'It may have been unpublished, moved, or the address is wrong.',
    exploreTitle: 'Explore on FotSpot',
    ...
    fieldSlugHint:
      'Made from the title when you save. Lowercase Latin letters, digits and hyphens. Changing it later breaks links people already have.',
    regenerateSlug: 'From title',
    fieldExcerpt: 'Excerpt',
    fieldExcerptHint:
      'One or two sentences. Shown on cards and used as the description in search results unless you set one below.',
    fieldContent: 'Content',
    fieldContentHint:
      'Markdown: # and ## for headings, **bold**, *italic*, [text](url), ![caption](image url), - lists, > quotes, --- for a rule. Links to /players, /academies or /trials stay inside FotSpot. A YouTube link on a line of its own becomes the player.',
    preview: 'Preview',
    write: 'Write',
    ...
    fieldCoverAlt: 'Cover alt text',
    fieldCoverAltHint: 'Describes the picture for screen readers and search engines.',
    upload: 'Upload',
    replace: 'Replace',
    removeImage: 'Remove',
    uploading: 'Uploading…',
    uploadFailed: 'The upload did not go through. Try again.',
    filingSection: 'Filing',
    filingHint: 'Where the post sits on the blog and how it is signed.',
    seoSection: 'SEO',
    seoHint: 'Each field falls back to the post itself when empty.',
    fieldSeoTitle: 'SEO title',
    fieldMetaDescription: 'Meta description',
    fieldSeoKeywords: 'Keywords',
    fieldSeoKeywordsHint:
      'Comma-separated. Suggested from the title, excerpt and text until you edit them; 3–8 specific terms work best.',
    suggestKeywords: 'Suggest',
    fieldCanonicalUrl: 'Canonical URL',
    fieldCanonicalUrlHint: 'Only if this story was first published elsewhere.',
    fieldOgTitle: 'Share title',
    fieldOgDescription: 'Share description',
    fieldOgImage: 'Share image',
    fieldOgImageHint: 'Shown when the link is shared. The cover is used when empty.',
    saveDraft: 'Save draft',
    save: 'Save',
    publish: 'Publish',
    unpublish: 'Unpublish',
    deletePost: 'Delete post',
    confirmDelete: 'Delete this post for good? Its likes and pictures go with it.',
    confirmUnpublish:
      'Take this post off the blog? Its address stops working until it is published again.',
    saved: 'Saved.',
    publishedToast: 'Published. It is live on the blog.',
    unpublishedToast: 'Unpublished.',
    deletedToast: 'Post deleted.',
    viewOnBlog: 'View on blog',
    manageCategories: 'Categories',
    manageCategoriesHint: 'The sections the blog is filed under. Removing one keeps its posts.',
    newCategory: 'New category',
    categoryName: 'Name',
    categorySlug: 'Address',
    categoryDescription: 'Description',
    categorySortOrder: 'Order',
    noCategories: 'No categories yet.',
    confirmDeleteCategory: 'Remove this category? Its posts stay, without a category.',
    lastEdited: 'Edited',
    previewNeedsSave: 'Save the post to preview the rendered article.',
    /* Media panel on /admin/blog/:id — upload, copy the URL, paste into the Markdown. */
    mediaTitle: 'Images for this post',
    mediaHint:
      'Upload a picture, copy its address and paste it into the content as ![description](address). Only the address is needed — the file lives on the CDN.',
    mediaUpload: 'Upload image',
    mediaEmpty: 'No images uploaded yet.',
    mediaCopyUrl: 'Copy URL',
    mediaCopyMarkdown: 'Copy Markdown',
    mediaCopied: 'Copied',
    mediaDelete: 'Delete',
    mediaDeleteTitle: 'Delete this image?',
    mediaDeleteHint:
      'It is removed from storage right away. If the content still refers to it, that picture will show as broken.',
    mediaDeleting: 'Deleting…',
    mediaOnlyImages: 'Only images (JPEG, PNG, WebP, GIF, AVIF) can be uploaded here.',
    mediaTooLarge: 'That file is over {max} MB. Resize it before uploading.',
    mediaSaveFirst: 'Save the post as a draft first, then upload images here.',
    createdFirst: 'Save the post once to upload pictures.',
  },
  landing: {
    ...
    recentlyJoined: 'FotSpot talents',
    recentlyJoinedBody: 'Players with rated evidence on their card — a different set each time.',
    viewMyCard: 'View My Card',
    watchHighlights: 'Watch Videos',
    latestClips: 'Trending players',
    latestClipsBody: 'The clips the feed is watching right now.',
