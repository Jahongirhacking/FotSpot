 ...
 * the squads (§1.10) — the server enforces that, so drawing a group picker here
 * would only be a control that fails. What a coach does with these players is
 * assess them, which happens on the player's own page, so every row is a link
 * there.
 */
