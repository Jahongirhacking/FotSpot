 ...
 *
 * Lucide dropped brand icons, so these are inline paths. Worth the markup: a
 * parent scanning a profile recognises the Telegram plane before they read any
 * word next to it, and in this market Telegram is where an academy actually
 * answers questions.
 *
 * Each carries its brand colour on hover only. Four saturated logos in a row
 * compete with the academy's own name for the top of the page, which is the one
 * thing on it that should be loudest.
 */
const NETWORKS = [
  {
    field: 'telegramUrl',
