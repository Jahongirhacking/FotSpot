...
export class GroupsService {
   ...
   * it is worth that only if whoever wrote it has watched them train. One
   * morning at a trial is enough to say *pass*; it is not enough to say
   * *physical 62*. Rule 22 keeps it off the trial screen for the same reason,
